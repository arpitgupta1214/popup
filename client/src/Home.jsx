          ...
          <aside>
            ...
            <div class="site-nav-icons">
              ...
              this.state.navobject["domain"] == "" ? "icon_inactive" : "icon_active"
                ...
                <li className={
              this.state.navobject["senders"] == "" ? "icon_inactive" : "icon_active"
              ...
              this.state.navobject["campaigns"] == "" ? "icon_inactive" : "icon_active"
                ...
                <li className={
              this.state.navobject["mailings"] == "" ? "icon_inactive" : "icon_active extra"
            ...
            <div class="site-nav">
              ...
              this.state.navobject["domain"] == "" ? "content" : "content active"
                ...
                <li className={
              this.state.navobject["senders"] == "" ? "content" : "content active"
            } onClick={() => this.sidebarFunc("senders")}>
              ...
              this.state.navobject["campaigns"] == "" ? "content" : "content active"
                ...
                <li className={
              this.state.navobject["mailings"] == "" ? "content extra" : "content active extra"
            } onClick={() => this.sidebarFunc("mailings")}>
